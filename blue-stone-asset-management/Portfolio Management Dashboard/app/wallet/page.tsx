...
export default function WalletPage() {
  return (
    <section className="space-y-6 rounded-3xl border border-border/70 bg-card p-8 shadow-sm">
      ...
      <h1 className="text-4xl font-semibold text-foreground">Track balances and fund activity</h1>
      <p className="max-w-2xl text-lg text-muted-foreground">
        Each route in the app router can now be reached directly while offering a home link back at any time.
      </p>
